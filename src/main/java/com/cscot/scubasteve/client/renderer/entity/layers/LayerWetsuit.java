...
@OnlyIn(Dist.CLIENT)
public class LayerWetsuit<T extends ModelBase> implements LayerRenderer<EntityLivingBase>
{
    ...
    public LayerWetsuit(RenderLivingBase<?> rendererIn) {
    ...
    protected void setModelSlotVisible(ModelBase p_188359_1_, EntityEquipmentSlot slotIn){}
    ...
    public ResourceLocation getArmorResource(net.minecraft.entity.Entity entity, ItemStack stack, EntityEquipmentSlot slot, @javax.annotation.Nullable String type) {
        ...
        String domain = ScubaSteve.MODID;
